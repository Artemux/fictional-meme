...
function StbApi() {
    ...
    this.SetDefaults = function () {
        ...
        if (this.GetEnv('language') != language) str += CONCAT + 'language ' + language;
        ...
        /*
         if ( this.GetEnv('proxyState') == '' ){
         this.SetEnv('proxyState false');
         }
         */
        this.SetWebProxy();
        //this.RouteAdd();
    ...
    this.GetLoaderUrl = function () {
        return "http://briz.ua/stb/mag/portal/programs/iptv/httpLoader.php?mac=" + this.GetDeviceMac();
    };
    this.GetOttLoaderUrl = function () {
        return "http://briz.ua/stb/mag/portal/programs/iptv2/httpLoader.php?mac=" + this.GetDeviceMac() + "&use_http=1";
    };
    this.GetInterfaceUrl = function () {
        return "http://briz.ua/stb/mag/portal/httpLoader.php?mac=" + this.GetDeviceMac();
    };
    this.GetVodServer = function () {
        return "http://briz.ua/stb/mag/portal/programs/media/";
    };
    this.GetIptvServer = function () {
        return "http://briz.ua/stb/mag/portal/programs/iptv_ott/index.html";
    };
    this.GetSambaPage = function () {
        return "http://briz.ua/stb/mag/portal/programs/samba/index.html";
    };
    this.GetHomePage = function () {
        return "http://briz.ua/stb/mag/portal/";
    };
    this.GetFirmwareURL = function () {
        return "http://briz.ua/stb/mag/firmware/imageupdate";
    };
    this.GetCurrentFirmwareVersion = function () {
        return 216
    };
    this.GetConfigPage = function () {
        return 1;
    };
    this.GetMainPage = function () {
        return 1;
    };
    this.GetFWVersion = function () {
        return stb.RDir("ImageVersion");
    };
    this.GetDisplayMode = function () {
        return 1;
    };
    this.GetVideoAspect = function () {
        return stb.GetAspect();
    };
    this.GetVideoContent = function () {
        return 1;
    };
    this.GetDeviceModel = function () {
        return stb.GetDeviceModel();
    };
    this.GetDeviceMemory = function () {
        return 1;
    };
    this.GetDeviceIP = function () {
        return stb.RDir("IPAddress").replace(/\n/gi, '')
    };
    this.GetDeviceWIP = function () {
        return stb.RDir("wifi_ip").replace(/\n/gi, '')
    };
    this.GetDeviceMac = function () {
        return stb.GetDeviceMacAddress();
    };
    this.GetFWUpgradeStatus = function () {
        return 1;
    };
    this.GetFWUpgradeStatusPercent = function () {
        return 1;
    };
    this.GetSmbGroups = function () {
        return stb.GetSmbGroups();
    };
    this.GetSmbServers = function (json) {
        return stb.GetSmbServers(json);
    };
    this.GetSmbShares = function (json) {
        return stb.GetSmbShares(json);
    };
    this.GetWifiLinkStatus = function () {
        return stb.GetWifiLinkStatus();
    }
    this.GetLanLinkStatus = function () {
        return stb.GetLanLinkStatus();
    }
    ...
    this.SetAutoUpdate = function () {
        if (stb.GetDeviceImageVersion() < this.GetCurrentFirmwareVersion()) {
            stbUpdate.startAutoUpdate(this.GetFirmwareURL(), true);
        }
    }

    this.SetEnv = function (value) {
        stb.RDir('setenv ' + value);
    };
    this.SetAudioPid = function (value) {
        stb.SetAudioPID(value);
    };
    this.SetStereoMode = function (value) {
        stb.SetStereoMode(value);
    };
    this.SetMenuType = function (type) {
        return 1;
    };
    this.SetVodServer = function (server) {
        return 1;
    };
    this.SetIptvServer = function (server) {
        return 1;
    };
    this.SetHomePage = function (server) {
        return 1;
    };
    this.SetConfigPage = function (server) {
        return 1;
    };
    this.SetMainPage = function (server) {
        return 1;
    };
    this.SetDisplayMode = function (value) {
        return 1;
    };
    this.SetVideoAspect = function (value) {
        stb.SetAspect(value);
    };
    this.SetVideoContent = function (value) {
        return 1;
    };
    this.SetFirmwareURL = function (url) {
        return 1;
    };
    this.SetModalMode = function (value) {
        return 1;
    };
    this.SetEventListener = function (value) {
        return 1;
    };

    this.IsPlaying = function () {
        return stb.IsPlaying();
    }
    this.SetWindow = function (x, y, w, h) {
        return 1;
    };
    ...
    this.Contin = function () {
        stb.Continue();
    };
    this.SetPosition = function (position) {
        stb.SetPosTime(position);
    };
    this.GetPosition = function () {
        return stb.GetPosTime();
    };
    ...
    this.SetListFilesExt = function (val) {
        stb.SetListFilesExt(val);
    };
    this.ListDir = function (dir) {
        return stb.ListDir(dir);
    }

    this.GetUserData = function (val) {
        return stb.LoadUserData(val);
    }
    this.SetUserData = function (val, data) {
        return stb.SaveUserData(val, data);
    }
    ...
    this.AddSmbServer = function (server_url, server_dir, local_name, login, password) {
        ...
        if (smb_result == 'Ok') {
            ...
            if (this.isSmbServerExists(server_url, server_dir) == false) {
                ...
                alert('this server is exist already');
            }
        } else {
            alert(smb_result);
        }
