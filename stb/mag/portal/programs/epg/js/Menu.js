			...
			if (max != 1){
				...
				if (typeof(this.servers[el]) != 'undefined'){
					if (this.dirs[el] != ''){	
						...
						text = '<div id="el'+id+'" class="button" name="'+this.name+'.Show(\''+this.servers[el].id+'\')"><div class="chanName">'+image + " " +this.servers[el].Name+'</div><div class="chanProgram">' + this.servers[el].Program + '</div></div>';			
