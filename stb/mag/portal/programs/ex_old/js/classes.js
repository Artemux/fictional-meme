            ...
            "show": function (mode, arr, before) {
                ...
                if (before && before == true && app.classes.list.deep >= 0) {
                    this.hide(function () {
                        ...
                        if (as.sublist) {
                            app.classes.list.cur_mode = app.classes.list.history[app.classes.list.deep].cur_mode;
                            as.sublist = false;
                        }
            ...
            "move": function (val) {
                switch (val) {
                            ...
                            if (app.classes.list.cur_item <= 0 && app.classes.list.cur_page > 0) {
                                ...
                                if (app.classes.list.cur_exPage > 0) {
                                    if (as.layer == as.layers.SUB_CATS_LIST) {
                                        ...
                                        app.classes.list.ctrls.move("begin", true);
                                    }
                                } else {
                                    app.classes.list.ctrls.move("begin", true);
                                }
                    ...
                    case "down":
                        ...
                        } else if (app.classes.list.cur_item + 1 < as.sizes[as.actualSize].max_list_lines && app.classes.list.cur_page < app.classes.list.pages_count) {
                            app.classes.list.cur_item++;
                        } else {
                ...
                "simpleFill": function (start, move) {
                    ...
                    for (var i = 0; i < items.length; i++) {
                        if (app.classes.list.items[i + start] != undefined) {
                            items[i].setAttribute('rel', app.classes.list.items[i + start].url);
