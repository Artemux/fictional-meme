app.keypress = {
    ...
    "als_hor": function (a) {
        if (a == 1) {
            $('ars_form').className = 'form_a';
            $('als_form').className = 'form_n';
            app.keypress.als_index_h = 2;
        } else {
            $('ars_form').className = 'form_n';
            $('als_form').className = 'form_a';
    ...
    "als_vert": function (a) {
        switch (app.keypress.als_index_h) {
            case 1:
                ...
                break;
            case 2:
                if ($('ars_line_' + app.keypress.als_index_v)) {
                    $('ars_line_' + app.keypress.als_index_v).className = 'als_line';
                    app.keypress.als_index_v += a;
                    if (app.keypress.als_index_v < 1) app.keypress.als_index_v = 1;
                    else if (app.keypress.als_index_v > app.keypress.als_max_v) app.keypress.als_index_v = app.keypress.als_max_v;
