...
Server.fetchFiles = function(url, folder_id, add_method, quality) {

	Popup.Show('Loading Files...', 'always');
	this.loader.GetFiles(url, folder_id, add_method, quality);
...
Server.fetchAutoComplete = function(name,add_method) {
	Popup.Show('Loading files...', 'always');
	this.loader.GetAutoComplete(name, add_method);
}
