...
//private:
	...
	this.GenreNext = function(){
	    ...
	    this.GenreDiv.innerHTML = "<div class=\"genreInfo\"><&nbsp "+GenresRus[this.genrePos]+" &nbsp></div>"
...
//initialization
	this.Init = function( cId )
	{
		...
		this.GenreDiv.innerHTML = "<div class=\"genreInfo\"><&nbsp "+GenresRus[this.genrePos]+" &nbsp></div>";
		this.TxtDiv.innerHTML = "<div class=\"pageInfo\">Страница 1 из "+this.pages+"</div>";
		this.SelectFirst();
	}
//select next element
	this.Next = function()
