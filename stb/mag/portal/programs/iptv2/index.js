...
var arrGenres = new Array(14);
	...
	arrGenres[9] = "ukraine";
	arrGenres[10] = "odessa";
	arrGenres[11] = "specials";
	arrGenres[12] = "shows";
	arrGenres[13] = "favorites";

var GenresRus = new Array(14);
	...
	GenresRus[7] = "HDTV";
	GenresRus[8] = "Российские";
	GenresRus[9] = "Украинские";
	GenresRus[10] = "Одесские";
	GenresRus[11] = "International";
	GenresRus[12] = "Развлекательные";
	GenresRus[13] = "Избранное";
...
window.onload = function() {
	...
	StalkerClient.setMac(Api.GetMAC());


	//alert(Api.GetOttLoaderUrl());
	$.getJSON(Api.GetOttLoaderUrl(), {
		g : ''
	}, function(genre) {
		MainMenu.List = genre;
		MainMenu.FirstPage();
