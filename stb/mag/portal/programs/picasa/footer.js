...
function getkeydown(e) {
	...
	if(curPage == Main_page){
			...
			break;
                        ...
                        /*case 38: //UP
                            if(curAction != 0){
                                //document.getElementById('mainPage_holder_'+curAction).blur();
                                document.getElementById('pc_authbox'+curAction).style.width = '0px';
                                //document.getElementById('pc_authbox'+curAction).style.opacity = 0;
                                curAction--;
                                //document.getElementById('pc_authbox'+curAction).style.opacity = 1;
                                document.getElementById('pc_authbox'+curAction).style.width = shift+'px';
                                //document.getElementById('mainPage_holder_'+curAction).focus();
                            }
                            else{
                        ...
                        break;*/
                        case 112: //RED
                            /*document.getElementById('userName_holder').focus();
                            document.getElementById('Pgalery').style.visibility ='visible';
                            document.getElementById('search').style.visibility ='hidden';
                            document.getElementById('auth').style.visibility ='hidden';*/
			break;
                        case 113: //GREEN
                            /*document.getElementById('keyword_holder').focus();
                            document.getElementById('Pgalery').style.visibility ='hidden';
                            document.getElementById('search').style.visibility ='visible';
                            document.getElementById('auth').style.visibility ='hidden';*/
                        break;
                        case 114: //YELLOW
                            /*document.getElementById('name_holder').focus();
                            document.getElementById('Pgalery').style.visibility ='hidden';
                            document.getElementById('search').style.visibility ='hidden';
		...
		if (ec == 33){
			if(curAlbumPage > 0){
				curAlbumPage--;
				fillPage(findAlbPict(str),findAlbTags(str),curAlbumPage);
			}
		}
		if (ec == 34){
			curAlbumPage++;
	...
	if(curPage == Pictures_page){
		switch(ec){
			...
			case 40: //DOWN
                                ...
                                /*
                                    var tempPage = found_pictSrc.length/(maxPictureLines*maxPictureColum);
                                    tempPage = tempPage - tempPage%1;
                                    if(curPictPage < tempPage){
                                        curPictPage++;
                                        changePage();
                                    }
	...
	if(curPage == SinglePicture_page){
		...
		if (ec == 37){
			if(curAlbumIdx>0){
				unselectItem(curAlbumIdx);
				curAlbumIdx--
				selectItem(curAlbumIdx);
			}
		}
